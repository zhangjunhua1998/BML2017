...
<div id="change">
<br/><br/><br/>
<from action="<?php echo site_url('liuyan/do_edit')?>" method="post">
    <input type="hidden" name="hid" value="<?php echo $editlist->id;?>">
    标题:<input type="text" name="title" value="<?php echo $editlist->title;?>"><br />
    内容:<textarea cols="10" name="con"><?php echo $editlist->contents;?></textarea>
